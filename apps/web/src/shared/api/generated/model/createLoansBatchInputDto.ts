 ...
 */
import type { CreateLoansBatchInputDtoDirection } from "./createLoansBatchInputDtoDirection";

export interface CreateLoansBatchInputDto {
  /**
   * @minItems 1
   * @maxItems 100
   ...
   */
  bookIds: string[];
  direction: CreateLoansBatchInputDtoDirection;
  /**
   * @nullable
